...
<!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
 <head> 
  ...
  <style>
        body {
            ...
            background-image: url("{{file_00000000b0c061fba32c79c0df7bf6cf.png}}"); // UBAH JADI LOGO LU
 ...
 <body> 
  <div class="container-center"> 
   <div class="card"> 
    <h3 style="font-size: 28px;" class="mb-3">Payment {{Nama Lu}}</h3> 
    <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
    <div class="payment-box"> 
     ...
     <span class="payment-text" id="payment-dana"> {{088803536269}}</span> 
    ...
    <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
     ...
     <span class="payment-text" id="payment-gopay">{{085746858365}}</span> 
     <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
    ...
    <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
     ...
     <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
     <span class="payment-text" id="payment-ovo">{(085746858365}}</span> 
     <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
     <button class="copy-btn" onclick="copyText('payment-ovo')"> <i class="bx bx-copy"></i> </button> 
     <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
    </div> 
    <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
    <button class="btn btn-primary mt-3" onclick="window.open("https://wa.me/{{088803536269}}");">Chat {{>contact Danzz<}}</button> 
   </div> 
   <!-- By @Dhilzzxd "Jangan Dihapus Jika Tidak Mau Error" -->
  </div> 
  <!-- Custom Alert --> 
